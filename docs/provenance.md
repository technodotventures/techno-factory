...
| factory.ai (research posts + product docs) | SOC-pipeline contrast: single agent 36% → SOC 90% parity on GDAL-family tasks; ~13× wall time; harness model-routing 58% cost cut. | Their platform/fleet scale |
