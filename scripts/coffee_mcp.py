...
Configuration (env overrides):
    COFFEE_TOKEN_STORE  token store path   (default /opt/data/mcp-tokens/meetcoffee.client.json)
    COFFEE_OAUTH_JSON   client credentials (default /opt/data/coffee_oauth_factory.json)
...
DEFAULT_TOKEN_STORE = os.environ.get("COFFEE_TOKEN_STORE", "/opt/data/mcp-tokens/meetcoffee.client.json")
DEFAULT_OAUTH_JSON = os.environ.get("COFFEE_OAUTH_JSON", "/opt/data/coffee_oauth_factory.json")
