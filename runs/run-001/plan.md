...
- **Work item:** card `redacted-id-19` — "Coffee MCP helper: auto-refresh expired tokens" (criteria written by the native Factory Planner; card moved to IN PROGRESS at run start).
